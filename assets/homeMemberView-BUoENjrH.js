import{g as u}from"./core-inoSP3gc.js";import{s as p}from"./sidebar-DH3GmQJw.js";import"./mockStorage-99A_-fjr.js";import"./bootstrap.esm-C8zcUHWS.js";import"./navigation-Bj4Ls0Yf.js";import"./data-CZaJBQaZ.js";let l=null,s=[],o=null;document.addEventListener("DOMContentLoaded",async()=>{await f(),p(),g(),y()});async function f(){l=await u(),l||(window.location.href="/ccsync-v1/pages/auth/login.html")}async function y(){try{{const e=await fetch("http://localhost:8000/api/member",{headers:{Authorization:`Bearer ${l.firebase_token}`,Accept:"application/json"}});if(!e.ok){const r=await e.json();throw new Error(r.message||`HTTP error! status: ${e.status}`)}s=(await e.json()).members}c(s)}catch(e){console.error("Error fetching members:",e);const n=document.getElementById("userTableBody");n.innerHTML=`
    <tr>
