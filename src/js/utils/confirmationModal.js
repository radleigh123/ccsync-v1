...
export class ConfirmationModal {
  ...
  show(titleText, messageText, options = {}) {
    ...
    // Apply optional button variants (e.g., danger)
    // Clean previous variants first
    this.yesBtn?.classList.remove("danger");
    this.noBtn?.classList.remove("danger");
    if (options.yesVariant === "danger") {
      this.yesBtn?.classList.add("danger");
    }
    if (options.noVariant === "danger") {
      this.noBtn?.classList.add("danger");
    }
  ...
  hide() {
    ...
    // Clean variant classes on hide to avoid leaking styles across uses
    this.yesBtn?.classList.remove("danger");
    this.noBtn?.classList.remove("danger");
  }
